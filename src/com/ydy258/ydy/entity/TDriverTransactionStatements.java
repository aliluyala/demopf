 ...
 */
@Entity
@Table(name = "t_driver_transaction_statements")
public class TDriverTransactionStatements implements java.io.Serializable {
	...
	private Double specialBalance;//专款
	...
	/** default constructor */
	public TDriverTransactionStatements() {
	}

	/** minimal constructor */
	public TDriverTransactionStatements(Long id, Long accountId,
	...
	/** full constructor */
	public TDriverTransactionStatements(Long id, Long accountId, Double pay,
