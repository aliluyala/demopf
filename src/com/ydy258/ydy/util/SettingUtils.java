...
import com.ydy258.ydy.CommonAttributes;
import com.ydy258.ydy.EnumConverter;
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File hytXmlFile = new ClassPathResource(CommonAttributes.SCITY_XML_PATH).getFile();
				Document document = new SAXReader().read(hytXmlFile);
				@SuppressWarnings("unchecked")
				List<Element> elements = document.selectNodes("/hyt/setting");
	...
	public static void set(Setting setting) {
		try {
			...
			try {
				...
				fileOutputStream = new FileOutputStream(hytXmlFile);
