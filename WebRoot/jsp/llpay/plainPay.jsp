...
<html>
    <head>
    	...
    	function ValidateNumber(e, pnumber)
    	{
    		...
    		if (reg.test(pnumber)&&pnumber.length<8)
        	{
    			sub.disabled = false;
    			sub.className = "btn orange w100 mt10";
        	}else{
        		sub.disabled = true;
    			sub.className = "btn dissubmit w100 mt10";
        	}
    	}
    	</script>
    </head>
    <body>
        ...
        <span class="logo"><a href="javascript:void(0)">用户充值</a>
        </span>
        <span class="fr about"><a href="<%=path %>about.jsp">关于</a>
        </span>
        </header>
        <section class="info">
         <form action="<%=path %>sys/pay/toPlainPay.action" method="post">
        <table border="0" cellspacing="0" cellpadding="0" class="table_ui" >
            <tr>
                <td colspan="2">
                    <span class="ft_gray">运的易充值</span>
                </td>
            </tr>
            <tr>
                <td width="50">
                    <span class="ft_gray">金额：</span>
                </td>
                <td style="text-align: left width:100px">
                   <input type="text" name="money_order"  onkeyup="ValidateNumber(this,value)"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                     <input type="submit" class="btn orange w100 mt10" value="提交支付" disabled="disabled" id="submitId" />
                </td>
            </tr>
        </table>
             <input type="hidden" name="paymod" value="plain"/>
            <input type="hidden" name="name_goods" value="充值"/>
            </form>
        </section>
