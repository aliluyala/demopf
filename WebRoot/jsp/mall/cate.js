...
Ext.onReady(function(){
    ...
    var store = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            method:'POST',
        	type: 'ajax',
            url: '../../sys/thirdmall/goodsCategoryListByPage.action',
            reader: {
                root: 'root',
    ...
    var queryButton = Ext.create('Ext.Button',{
    	...
    	handler: function() {
    		paras.categoryName = encodeURIComponent(Ext.getCmp("cateName").getValue());
    		store.load();
		}
    });
	...
	var tbar = Ext.create("Ext.Toolbar", {
	    ...
	    items: [
			    ...
			    {width:180,labelWidth:65,name:'cateName',id:'cateName',xtype:'textfield',fieldLabel:'类型名称'},
		    	queryButton
	    ]
	});
