...
Ext.onReady(function(){
    ...
    Ext.define('travelModel', {
        ...
        fields: ['orderNo','policyNo','recognizeePhone','insuredAmount','departureDate','effDate','recognizeeName','recognizeePhone','cardNo','policyNo',
                 'company','status','created_date','policyPath','days','endDate','personsCount','fromLoc','toLoc','registerNo'
        ],
        idProperty: 'id'
    });
    ...
    var store = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            method:'POST',
        	type: 'ajax',
            url: '../../sys/proxy/accidentInsuranceChinaLifeByPage.action',
            reader: {
                root: 'root',
    ...
    var queryButton = Ext.create('Ext.Button',{
    	...
    	handler: function() {
    		...
    		alert(Ext.getCmp("orderNo").getValue());
	    ...
	    items: ['-',
	            {
			        ...
			        handler: function () {
			        	...
			        	Ext.MessageBox.confirm("提示","确定要撤单吗？",function(but){
			        		if(but=='yes'){
			        			Ext.Ajax.request({url:'../../sys/proxy/cancleAccidentChinaLifeInsurance.action',  
