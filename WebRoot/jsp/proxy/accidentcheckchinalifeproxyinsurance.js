...
Ext.onReady(function(){
    ...
    Ext.define('travelModel', {
        ...
        fields: ['orderNo','policyNo','goodsName','weigthOrCount','packQty','cargoNo','goodsTypeNo','mainGlausesCode','insuredAmount','truckType',
                 ...
                 'company','status','created_date','policyPath','days','endDate','personsCount','registerNo'
        ],
        idProperty: 'id'
    });
    ...
    var store = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            method:'POST',
        	type: 'ajax',
            url: '../../sys/proxy/accidentInsuranceCheckChinaLifeByPage.action',
            reader: {
                root: 'root',
	            ...
	            '-',{
			        ...
			        handler: function () {
	                	...
	                	Ext.getCmp('orderNo').setValue(records[0].data.orderNo);
				  		...
				  		Ext.getCmp('endDate').setValue(records[0].data.endDate);
				  		Ext.getCmp('days').setValue(records[0].data.days);
				  		Ext.getCmp('fromLoc').setValue(records[0].data.fromLoc);
				  		Ext.getCmp('toLoc').setValue(records[0].data.toLoc);
				  		Ext.getCmp('registerNo').setValue(records[0].data.registerNo);
				  		if(records[0].data.personsCount==2){
				  			Ext.getCmp('set1').show();
				  			Ext.getCmp('recognizeeName').setValue(records[0].data.recognizeeName.split("/")[0]);
					  		Ext.getCmp('cardNo').setValue(records[0].data.cardNo.split("/")[0]);
					  		Ext.getCmp('recognizeePhone').setValue(records[0].data.recognizeePhone.split("/")[0]);
				  			Ext.getCmp('recognizeeName1').setValue(records[0].data.recognizeeName.split("/")[1]);
					  		Ext.getCmp('cardNo1').setValue(records[0].data.cardNo.split("/")[1]);
					  		Ext.getCmp('recognizeePhone1').setValue(records[0].data.recognizeePhone.split("/")[1]);
				  		}else{
...
//	            },
        	...
        	listeners: {
                itemdblclick: function (me, record, item, index, e, eOpts) {
                	...
                	Ext.getCmp('orderNo2').setValue(record.data.orderNo);
			  		...
			  		Ext.getCmp('endDate2').setValue(record.data.endDate);
			  		Ext.getCmp('days2').setValue(record.data.days);
			  		Ext.getCmp('fromLoc2').setValue(record.data.fromLoc);
			  		Ext.getCmp('toLoc2').setValue(record.data.toLoc);
			  		Ext.getCmp('registerNo2').setValue(record.data.registerNo);
			  		if(record.data.personsCount==2){
			  			Ext.getCmp('set3').show();
			  			Ext.getCmp('recognizeeName2').setValue(record.data.recognizeeName.split("/")[0]);
				  		Ext.getCmp('cardNo2').setValue(record.data.cardNo.split("/")[0]);
				  		Ext.getCmp('recognizeePhone2').setValue(record.data.recognizeePhone.split("/")[0]);
			  			Ext.getCmp('recognizeeName3').setValue(record.data.recognizeeName.split("/")[1]);
				  		Ext.getCmp('cardNo3').setValue(record.data.cardNo.split("/")[1]);
				  		Ext.getCmp('recognizeePhone3').setValue(record.data.recognizeePhone.split("/")[1]);
			  		}else{
  ...
  var  checkwindow = new Ext.Window({  
      ...
      items:[{  
          ...
          xtype:'form',
          style:'padding:8px;',  
          url: '../../sys/proxy/accidentCheckChinaLife.action',
          labelWidth:40,  
          items:[
                 {
