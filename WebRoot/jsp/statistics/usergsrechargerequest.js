...
Ext.onReady(function(){
    ...
    var store = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            method:'POST',
        	type: 'ajax',
            url: '../../sys/statistics/usergsRechargeRequest.action',
            reader: {
                root: 'root',
	    ...
	    items: ['-',
	            {
			        ...
			        handler: function () {
			        	...
			        	Ext.Ajax.request({url:'../../sys/statistics/querygsRechargeRequest.action',  params : {tradeId:records[0].data.id},method:'post',type:'json',  success:function(result, request){
							...
							Ext.getCmp("orderNeedSpecialBalance").setValue(responseObj.data['orderNeedSpecialBalance']);
							Ext.getCmp("userSpecialBalance").setValue(responseObj.data['userSpecialBalance']);
							Ext.getCmp("orderNo_").setValue(responseObj.data['orderNo']);
							Ext.getCmp("specialBalance").setValue(responseObj.data['specialBalance']);
  ...
  var windowshow = new Ext.Window({  
      ...
      items:[{  
          ...
          xtype:'form',
          style:'padding:8px;',  
          url: '../../sys/statistics/balanceUsergsRechargeRequest.action',
          labelWidth:30,  
          ...
          items:[
	  		...
	  		{  
		      	  id:'orderNeedSpecialBalance',
		      	  name:'orderNeedSpecialBalance',
		      	  disabled:false,
		      	  readOnly:true,
		      	  labelWidth:120,
		      	  width : 65,
	              xtype:'textfield',  
	              fieldLabel:'本单最多可用专用费'
		  	    },
	  	  {  
		      	  id:'userSpecialBalance',
		      	  name:'userSpecialBalance',
		      	  readOnly:true,
		      	  labelWidth:120,
		      	  width : 65,
	              xtype:'textfield',  
