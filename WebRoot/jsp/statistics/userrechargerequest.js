...
Ext.onReady(function(){
    ...
    var store = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            method:'POST',
        	type: 'ajax',
            url: '../../sys/statistics/userRechargeRequest.action',
            reader: {
                root: 'root',
	...
	var tbar = Ext.create("Ext.Toolbar", {
	    ...
	    items: ['-',
	            ...
	            '-','->',{width:180,labelWidth:60,name:'orderNo',id:'orderNo',xtype:'textfield',fieldLabel:'订单编号'},'-',
					{
				        xtype: 'datefield',
				        id:'startTime',
				        labelWidth: 55,
  ...
  var windowshow = new Ext.Window({  
      ...
      items:[{  
          ...
          xtype:'form',
          style:'padding:8px;',  
          url: '../../sys/statistics/balanceUserRechargeRequest.action',
          labelWidth:30,  
  ...
  var windowgsshow = new Ext.Window({  
      title:'确认信息',  
      width:500,  
      height:600,  
      closeAction:'hide',  
